...
const MacBookPro16ThirteenPage = () => {
  return (
    <>
        ...
        <div className="flex flex-col md:gap-10 gap-[180px] items-center justify-start max-w-[1351px] mb-[61px] mx-auto w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
            <div className="flex md:flex-1 flex-col items-start justify-start w-[36%] md:w-full">
              ...
              <div className="h-[78px] md:h-[93px] mt-[15px] relative w-full">
              ...
              <Button className="bg-black-900 border-2 border-solid border-white-A700 cursor-pointer font-light leading-[normal] min-w-[285px] mt-11 py-[23px] text-2xl md:text-[22px] text-center text-white-A700 sm:text-xl">
                Generate Playlist
              </Button>
              <Button className="bg-black-900 border-2 border-solid border-white-A700 cursor-pointer font-light leading-[normal] min-w-[285px] mt-11 py-[23px] text-2xl md:text-[22px] text-center text-white-A700 sm:text-xl">
                Copy Selected Track
...
export default MacBookPro16ThirteenPage;
